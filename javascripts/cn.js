...
var Restr=/^\d{12}$/;
 $("form").submit(function(e) {
 	...
 	if (sval == $("#tracking").attr('fs') || sval == '') {
		...
		$('#qpart').append('<div id="toast" style="height:35px;display:none;width:246px;position:absolute;left:2px;bottom:48px;background:#fdf6e2;color:#f86d00;font-weight:bold;text-align:center;line-height:35px;font-size:14px;font-weight:bold;">请输入12位运单号追踪</div>');
